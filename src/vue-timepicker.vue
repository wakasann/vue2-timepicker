...
export default {
  ...
  props: {
    ...
    inputIdAttr: {type: String,default: 'vue2-timepicker'},
    inputNameAttr: {type: String, default: 'vue2timepicker'},
    inputClassAttr: {type: String, default: 'display-time'}
  },
...
<span class="time-picker">
  <input :class="inputClassAttr" :id="inputIdAttr" :name="inputNameAttr" v-model="displayTime" @click.stop="toggleDropdown" type="text" readonly />
